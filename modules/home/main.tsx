      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
        <div className="relative">
          ...
          <div className="absolute bottom-16 left-12">
            ...
            <h3 className="text-xl font-bold mb-6 text-white">Chất lượng</h3>
            <Link
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-16 left-12">
            ...
            <h3 className="text-xl font-bold mb-6 text-white">100% Len</h3>
            <Link
              className="inline-block bg-white px-8 py-2 text-sm font-medium border border-white hover:bg-transparent hover:text-white transition-colors uppercase"
              href="#"
            >
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-16 left-12">
            ...
            <h3 className="text-xl font-bold mb-6 text-white">Thảm lông</h3>
            <Link
              className="inline-block bg-white px-8 py-2 text-sm font-medium border border-white hover:bg-transparent hover:text-white transition-colors uppercase"
              href="#"
            >

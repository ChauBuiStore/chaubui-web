...
export function XMenu({ items, className, orientation = 'horizontal', expandMode = 'always', onItemClick }: XMenuProps) {
  ...
  const renderVerticalMenuItem = (item: MenuItem, index: number, level = 0) => {
    ...
    const shouldShowChildren = expandMode === 'always' || (expandMode === 'collapse' && isExpanded);
